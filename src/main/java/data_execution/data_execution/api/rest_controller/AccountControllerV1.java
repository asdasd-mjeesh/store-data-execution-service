...
import data_execution.data_execution.dto.request.incoming.account.AccountRequest;
...
import data_execution.data_execution.service.account.confirmation.AccountConfirmationService;
...
import data_execution.data_execution.service.mapper.response.outgoing.account.AccountResponseMapper;
import data_execution.data_execution.service.mapper.request.incoming.account.AccountRequestMapper;
...
public class AccountControllerV1 {
    ...
    public ResponseEntity<String> confirmAccount(@RequestParam("token") String confirmationToken) {
        boolean isConfirmed = accountConfirmationService.confirm(confirmationToken);
        if (isConfirmed) {
